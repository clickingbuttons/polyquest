...
//        BackfillAllStats groupedStats = BackfillRange.backfill(from, to, BackfillRange.BackfillMethod.grouped, "");
//        groupedStats.writeSymbols("jack_agg1d_grouped.csv");
//        groupedStats.writeJSON("jack_agg1d_grouped.json");
        BackfillAllStats aggStats = BackfillRange.backfill(from, to, BackfillRange.BackfillMethod.aggs, "");
