...
//        Calendar to = new GregorianCalendar(2005, Calendar.JANUARY, 1);
        BackfillAllStats groupedStats = BackfillRange.backfill1d(from, to, BackfillRange.BackfillMethod.grouped, "");
        groupedStats.writeSymbols("jack_agg1d_grouped.csv");
        groupedStats.writeJSON("jack_agg1d_grouped.json");
        BackfillAllStats aggStats = BackfillRange.backfill1d(from, to, BackfillRange.BackfillMethod.aggs, "");
